...
argp.add_argument('-a', '--arch', help = 'Model architecture', default = 'vgg19', choices = ['densenet', 'vgg19', 'squeezenet', 'alexnet', 'resnet'])
...
model = train(model, epochs, learning_rate, criterion, optimizer, dataloaders['train'], dataloaders['valid'], device, save_dir)
